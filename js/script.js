...
let indElem = document.querySelector('#index');
let index = 0;
let points = 0;
...
function saveResults(){
    ...
    gameCount += 1;
    sumOfPoints += points;
    avgPoints = sumOfPoints/gameCount;

    averagePoints.innerHTML = avgPoints;

    localStorage.setItem("points", sumOfPoints);
    localStorage.setItem("gameCount", gameCount);
    localStorage.setItem("averagePoints", avgPoints);
    //let obj = JSON.parse(localStorage.getItem("points"));
}
